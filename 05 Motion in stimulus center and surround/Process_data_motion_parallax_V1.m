...
if (calc_flag == 1)
    ...
    save r_burst_data_V1 r_burst* burst_counts barray_* fbarray_* afbarray_* r_trans* r_stead*
end
...
load r_burst_data_V1.mat afbarray_*
h = figure(8);
...
load r_burst_data_V1.mat  r_trans* r_stead*
...
for i = 1:3
    ...
    xlabel('Centre temporal frequency (Hz)')
    % ylabel('Rate (Hz)')
    set(gca,'ytick',0:20:140,'yticklabel',{'','','','','','','',''})
    set(gca,'xtick', tf)
    if (i<3)
        eval(['title(''Transient: ' num2str(i) ' spb'' )'])
    else
